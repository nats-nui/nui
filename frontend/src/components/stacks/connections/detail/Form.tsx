        ...
        <TitleAccordion title="TLS CLIENT AUTH">
            < div className="cmp-h">
                <IconToggle
                    ...
                    readOnly={inRead}
                />
                <div className="lbl-prop">ENABLE</div>
            </div>
            <div className="lyt-v">
                <div className="lbl-prop">CLIENT CERT PATH</div>
                <TextInput autoFocus
            ...
            <div className="lyt-v">
                <div className="lbl-prop">CLIENT KEY PATH</div>
                <TextInput autoFocus
            ...
            <div className="lyt-v">
                <div className="lbl-prop">CA PATH</div>
                <TextInput autoFocus
